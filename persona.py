...
class Persona:
    ...
    def setNombre(self, nombre): self.nombre = nombre # Nombre
    
    def getNombre(self): return self.nombre
    
    def setApellido(self, apellido): self.apellido = apellido # Apellido
    
    def getApellido(self): return self.apellido
    
    def setCedula(self, cedula): self.cedula = cedula # Cedula de Identidad

    def getCedula(self): return self.cedula

    def setTelefono(self, telefono): self.telefono = telefono # Número de Teléfono
    
    def getTelefono(self): return self.telefono
    
    def setCorreo(self, correo): self.correo = correo # Correo Electrónico
    
    def getCorreo(self): return self.correo
    
    def setConsejo(self, consejo): self.consejo = consejo # Consejo Comunal al que pertenece
    
    def getConsejo(self): return self.consejo
    
    def setEquipo(self, equipo): self.equipo = equipo # Unidad o Comité al que pertenece dentro de la comuna
    
    def getEquipo(self): return self.equipo

    # Ingresar datos de una Persona
    # editar = 0
    # Agregar una persona || Editar los datos de una persona
    # editar = 1,2,3,4,5,6,7
    # Se esta editando un atributo en especifico
    ...
    def Mostrar_Persona(self):
        ...
        print("Correo: ", end='')
        print(self.getCorreo(),"@gmail.com",sep='') # probando end y sep
